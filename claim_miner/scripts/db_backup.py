...
# -*- coding:utf-8 -*-
"""
Copyright Conversence 2022-2024
License: Apache 2.0
"""
...
def rotate_database_dumps(
    dbdumps_dir, db, daily=4, weekly=4, monthly=4, yearly="always"
):
...
def database_dump(
    dbdumps_dir, password, host, user, db, dump_format="custom", **kwargs
):
    """
    Dumps the database
    """
